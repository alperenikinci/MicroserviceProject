...
import static com.alperenikinci.exception.ErrorType.*;
@ControllerAdvice
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerAuthMicroseviceException(SalesMicroserviceException exception){
